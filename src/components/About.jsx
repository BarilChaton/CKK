        ...
        <div className='flex flex-col justify-center items-center w-full h-full'>
            <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
              ...
              <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
                ...
                <div className='mb-10'>
                <p className='mb-40'>
                    I'm a freshly baked Junior Game Developer currently employed by Relax Gaming in Malmö, Sweden.
                    ...
                    My speciality of choosing is Game design development and Frontend design in games. Given that I have something of an artistic eye, I find it to be suitable for me.
                  </p>
                </div>
              </div>
            </div>
